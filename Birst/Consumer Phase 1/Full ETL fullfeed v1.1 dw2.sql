...
and (sl.sent_date between  '11/28/2016' and '12/05/2016')
...
and (alsent.sent_date between  '11/28/2016' and '12/05/2016')
union all
...
Where pl.call_start between '11/28/2016' and '12/05/2016'
) d;
